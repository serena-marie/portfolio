    ...
    <div className="aboutContainer">
      ...
      <div className='bioContainer'>
        ...
        <div className="bio">
          ...
          <p>
            I previously worked as a team of one, developing and maintaining features for an internal web-based tool used by the Support and Engineering teams at Lightstream. I also have a professional background in Customer Support, and I constantly think about the user experience. In 2019, I graduated from Texas State University with a Bachelor's in Computer Science. Throughout college, I worked with C/C++ and Python and some of my favorite electives were Maching Learning, Computer Vision, and Statiscal Genetics + Bioinformatics.
          </p>
          <p>
